...
const activateAccount = (link) => {
  const htmlContent = `
  <p>
  Anda menerima email ini karena Anda telah melakukan Registrasi Akun di Recipe Food.
  <br>
...
<p>
  Jika Anda tidak merasa melakukan Registrasi Akun di Recipe Food, abaikan email ini.
  <br>
